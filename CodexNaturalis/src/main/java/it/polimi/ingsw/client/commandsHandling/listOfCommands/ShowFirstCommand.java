...
public class ShowFirstCommand implements CommandManager {
    private Client client;
    public ShowFirstCommand(Client client) {
        this.client = client;
    }
    public void handleMessage(String[] commands, stateEnum currState) throws RemoteException, CommandNotAvailableException {
        ...
        Message toSend = new ShowFirstRequest(messEnum.SHOW_FIRST_CARD, client.getUsername());
